...
public:
    ...
    SLresult setPlayerMute();

    SLresult setPlayerNotMute();

    SLmillibel getVolumeLevell();

    SLmillibel setVolumeLevel(SLmillibel volume);

    SLmillibel getMaxVolumeLevel();

    SLresult getMaxVolumeLevel(SLmillibel volume);
};
