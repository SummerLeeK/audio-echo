...
JNIEXPORT void JNICALL
Java_com_google_sample_echo_MainActivity_startRecord(JNIEnv *env, jclass type);
}
...
Java_com_google_sample_echo_MainActivity_createAudioRecorder(JNIEnv *env, jclass type,
    ...
    sampleFormat.sampleRate_ = engine.fastPathSampleRate_;
    sampleFormat.framesPerBuf_ = engine.fastPathFramesPerBuf_;
    engine.recorder_ = new AudioRecorder(&sampleFormat, engine.slEngineItf_, path);
    if (!engine.recorder_) {
        return JNI_FALSE;
    }
...
Java_com_google_sample_echo_MainActivity_getAudioRecorderVolumeLevel(JNIEnv *env, jclass type) {

    // TODO
    uint16_t volume = engine.recorder_->getVolume();
    return volume;
}

//JNIEXPORT jint JNICALL
//Java_com_google_sample_echo_MainActivity_setAudioPlayMute(JNIEnv *env, jclass type) {
//
//    // TODO
//    SLresult sLresult;
//
//    sLresult = engine.player_->setPlayerMute();
//    return sLresult;
//
//}
//
//extern "C"
//JNIEXPORT jint JNICALL
//Java_com_google_sample_echo_MainActivity_setAudioPlayNotMute(JNIEnv *env, jclass type) {
//
...
Java_com_google_sample_echo_MainActivity_setAudioPlayNotMute(JNIEnv *env, jclass type) {
    ...
    sLresult = engine.player_->setPlayerNotMute();

    return sLresult;
}extern "C"
JNIEXPORT jshort JNICALL
Java_com_google_sample_echo_MainActivity_getAudioPlayerVolumeLevel(JNIEnv *env, jclass type) {

    // TODO
    SLmillibel volume = engine.player_->getVolumeLevell();
    return volume;
}extern "C"
JNIEXPORT jshort JNICALL
Java_com_google_sample_echo_MainActivity_getMaxAudioPlayerVolumeLevel(JNIEnv *env, jclass type) {

    // TODO
    SLmillibel volume = engine.player_->getMaxVolumeLevel();
    return volume;
}extern "C"
JNIEXPORT jint JNICALL
Java_com_google_sample_echo_MainActivity_setAudioPlayerVolumeLevel(JNIEnv *env, jclass type,
                                                                   jint volume_) {

    // TODO
    SLmillibel volume = volume_;
    SLresult result = engine.player_->setVolumeLevel(volume);

    return result;
}extern "C"
JNIEXPORT void JNICALL
Java_com_google_sample_echo_MainActivity_stopRecord(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_google_sample_echo_MainActivity_pauseRecord(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_google_sample_echo_MainActivity_restartRecord(JNIEnv *env, jclass type) {

    // TODO
    engine.recorder_->Restart();
}